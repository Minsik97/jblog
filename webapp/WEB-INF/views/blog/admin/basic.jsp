	...
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="admin-content">
				<form action="${pageContext.request.contextPath}/${authUser.id}/fileUpdate" method="post"  enctype="multipart/form-data">
	 		      	<table id="admin-basic">
			      		...
			      		<tr>
			      			...
			      			<c:choose>
			      				...
			      				<c:otherwise>
			      					<td class="text-left"><img src="${pageContext.request.contextPath}/assets/image/upload/${blogVo.logoFile}"></td>
			      				</c:otherwise>
			      			</c:choose>
			      		</tr>      		
			      		<tr>
